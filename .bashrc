...
PATH=$PATH:/opt/Xilinx/14.2/ISE_DS/ISE/bin/lin64/
#echo "Smile and the world smiles with you!"
#echo "Tasks for today!"
#echo "What is the scope of the variable"
#echo "Complete the algorithm assignment!"
#work=$(pwd | awk -F "/" '{print $(NF-1)"/"$NF}')

#PS1="\[\033]0;\u:${NEW_PWD}\007\]\n\[\033[0;1;97;44m\] \u \[\033[0;34;104m\]\[\033[0;1;97;104m\] \h \[\033[0;94;107m\]\[\033[0;90;1;107m\] ${work} \[\033[0;97;49m\]\[\033[1;38;5;74m\]"
